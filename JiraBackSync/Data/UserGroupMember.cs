...
namespace JiraBackSync.Data
{
    ...
    public class UserGroupMember : INotifyPropertyChanged
    {
        ...
        public static UserGroupMember FromJson(string data)
        {
            return JsonConvert.DeserializeObject<UserGroupMember>(data);
        }
